...
# ── Приклад 4: Конструктор LEGO (категорія 743) ──────────────────────────────────────
run_example(
    "🧱 ПРИКЛАД 4: Конструктор LEGO",
    """LEGO Star Wars Зореліт Джанго Фетта (75433) НОВИЙ, Новий набір LEGO Star Wars Зореліт Джанго Фетта з фільму Атака клонів""",
    category_id=743,
    advertisement_id="a475db59-b3dc-4c13-93bc-278b53eb0a95")

# ── Приклад 5: Колекційна фігурка (категорія 1677) ──────────────────────────────────────
run_example(
    "🎭 ПРИКЛАД 5: Колекційна фігурка",
    """Фігурка Вілл Байерс Stranger Things Kinder Joy колекційна Netflix,"Колекційна мініатюрна фігурка Вілла Байерса з культового серіалу Stranger Things від Netflix.""",
    category_id=1677,
    advertisement_id="547e2974-e8d8-43c9-9366-fe924142120b")

# ── Приклад 6: Колеса в зборі (категорія 1261) ──────────────────────────────────────
run_example(
    "🚗 ПРИКЛАД 6: Колеса в зборі",
    """Оригінальний диск Toyota R17 5x114.3 - новий, не використовувався","Оригінальний литий диск Toyota діаметром 17 дюймів з розболтовкою 5x114.3.""",
    category_id=1261,
    advertisement_id="d78ba6db-54d3-4c00-b19e-eabda37a7667")

# ── Приклад 7: Стілець (категорія 1320) ──────────────────────────────────────
run_example(
    "🪑 ПРИКЛАД 7: Стілець",
    """Стілець JYSK оксамитовий сірий з дерев'яними ніжками,"Стілець JYSK з оксамитовим сірим оббиванням та дерев'яними ніжками.""",
    category_id=1320,
    advertisement_id="3be84b0b-6861-4584-9f22-b72f16e6ba8e")
